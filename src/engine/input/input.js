...
Input.prototype.isLeftButtonPressed = function(borders) {
	return this.isButtonPressed(this.leftButton, borders);
}
Input.prototype.isRightButtonDown = function(borders) {
	return this.isButtonDown(this.rightButton, borders);
}
Input.prototype.isRightButtonPressed = function(borders) {
	return this.isButtonPressed(this.rightButton, borders);
}
Input.prototype.isMiddleButtonDown = function(borders) {
	return this.isButtonDown(this.middleButton, borders);
}
Input.prototype.isMiddleButtonPressed = function(borders) {
...
Input.prototype.onmouseup= function(event) {
	...
	this.lastButtons[event.button] = 1;
}
